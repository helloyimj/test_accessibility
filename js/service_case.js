...
$(document).ready(function () {
    ...
    page_title_rep_case +=    '<h3>더 빠르게, 더 간편하게<br />내게 가장 익숙한 플랫폼에서 공공서비스를 이용할 수 있습니다.</h3>'; 
...
$(document).ready(function () {
    ...
    page_rep_case_list +=           '<li><a href="03_적용사례_서비스별 사례_세종·백두대간 수목원 예약.html" target="_self" class="service_item item_sjbdarboretum" title="세종·백두대간 수목원 예약 서비스별 사례 소개 부분으로 이동">세종·백두대간 수목원 예약</a></li>'; 
    ...
    page_rep_case_list +=                   '<option value="03_적용사례_서비스별 사례_세종·백두대간 수목원 예약.html" class="service_option">세종·백두대간 수목원 예약</option>'; 
