...
header +=                    '<a href="00_대외홍보포털_메인.html" target="_self" class="logo_anchor" title="디지털서비스개방 메인 화면으로 이동"></a>';
header +=                '</h1>';
...
header +=                        '<a href="javascript:;" target="_self" class="btn_util_ham" aria-label="lnb 메뉴 열기" title="전체 메뉴 열기"></a>';
header +=                    '</div>';
header +=                '</div>';
